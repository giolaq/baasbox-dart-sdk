...
["baasbox", "../../lib/baasbox.dart", , O, {
  ...
  BaasBoxContext: {
    ...
    rest$4: function(method, endpoint, authenticate, body) {
      ...
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new O.BaasBoxContext_rest_closure(this, completer, any)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      return completer.future;
    },
  ...
  BaasBoxContext_rest_closure: {
    "^": "Closure:12;this_0,completer_1,any_2",
    call$1: function($event) {
      ...
      t1 = t1.response;
      if (t2)
        parsedBody = C.JsonCodec_null_null.decode$1(W._convertNativeToDart_XHR_Response(t1));
      else
        P.print(C.JSString_methods.$add("Error ", W._convertNativeToDart_XHR_Response(t1)));
...
["", "baasboxweb.dart", , F, {
  "^": "",
  main: [function() {
    var t1 = document.querySelector("#login");
    t1.textContent = "Login";
    t1 = J.get$onClick$x(t1);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(F.login$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = document.querySelector("#logout");
    t1.textContent = "Logout";
    t1 = J.get$onClick$x(t1);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(F.logout$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = document.querySelector("#signup");
    t1.textContent = "Signup";
    t1 = J.get$onClick$x(t1);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(F.signup$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = document.querySelector("#currentuser");
    t1.textContent = "Current User";
    t1 = J.get$onClick$x(t1);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(F.fetchCurrentUser$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  }, "call$0", "main$closure", 0, 0, 0],
  login: [function($event) {
    var aBBUser = new O.BaasBoxUser("Giovanni", null, null, null, null, null, null);
    aBBUser._password = "test";
    aBBUser.login$0().then$1(new F.login_closure()).catchError$1(new F.login_closure0());
  }, "call$1", "login$closure", 2, 0, 1],
  logout: [function($event) {
    O.BaasBoxContext_BaasBoxContext().rest$3("POST", "/logout", true).then$1(new F.logout_closure()).catchError$1(new F.logout_closure0());
  }, "call$1", "logout$closure", 2, 0, 1],
  signup: [function($event) {
    O.BaasBoxContext_BaasBoxContext().rest$4("POST", "/user", false, P.LinkedHashMap_LinkedHashMap$_literal(["username", "Giovanni", "password", null], null, null)).then$1(new F.signup_closure()).catchError$1(new F.signup_closure0());
  }, "call$1", "signup$closure", 2, 0, 1],
  fetchCurrentUser: [function($event) {
    O.BaasBoxContext_BaasBoxContext().rest$3("GET", "/me", true).then$1(new F.fetchCurrentUser_closure()).catchError$1(new F.fetchCurrentUser_closure0());
  }, "call$1", "fetchCurrentUser$closure", 2, 0, 1],
  login_closure: {
    "^": "Closure:12;",
    call$1: function(user) {
      return P.print("Login ok for " + H.S(user));
    }
  },
  login_closure0: {
    "^": "Closure:12;",
    call$1: function(e) {
      return P.print("Error " + H.S(e) + ")");
    }
  },
  logout_closure: {
    "^": "Closure:12;",
    call$1: function(user) {
      return P.print("Logout ok for " + H.S(user));
    }
  },
  logout_closure0: {
    "^": "Closure:12;",
  ...
  signup_closure: {
    "^": "Closure:12;",
    call$1: function(user) {
      return P.print("Signup ok for " + H.S(user));
    }
  },
  signup_closure0: {
    "^": "Closure:12;",
  ...
  fetchCurrentUser_closure: {
    "^": "Closure:12;",
    call$1: function(user) {
      return P.print("Current user info ok for " + H.S(user));
    }
  },
  fetchCurrentUser_closure0: {
    "^": "Closure:12;",
    call$1: function(e) {
      return P.print("Error " + H.S(e) + ")");
    }
...
function dart_precompiled($collectedClasses) {
  ...
  function login_closure() {
  }
  login_closure.builtin$cls = "login_closure";
  if (!"name" in login_closure)
    login_closure.name = "login_closure";
  $desc = $collectedClasses.login_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  login_closure.prototype = $desc;
  function login_closure0() {
  }
  login_closure0.builtin$cls = "login_closure0";
  if (!"name" in login_closure0)
    login_closure0.name = "login_closure0";
  $desc = $collectedClasses.login_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  login_closure0.prototype = $desc;
  function logout_closure() {
  }
  logout_closure.builtin$cls = "logout_closure";
  if (!"name" in logout_closure)
    logout_closure.name = "logout_closure";
  $desc = $collectedClasses.logout_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  logout_closure.prototype = $desc;
  function logout_closure0() {
  }
  logout_closure0.builtin$cls = "logout_closure0";
  if (!"name" in logout_closure0)
    logout_closure0.name = "logout_closure0";
  $desc = $collectedClasses.logout_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  logout_closure0.prototype = $desc;
  function signup_closure() {
  }
  signup_closure.builtin$cls = "signup_closure";
  if (!"name" in signup_closure)
    signup_closure.name = "signup_closure";
  $desc = $collectedClasses.signup_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  signup_closure.prototype = $desc;
  function signup_closure0() {
  }
  signup_closure0.builtin$cls = "signup_closure0";
  if (!"name" in signup_closure0)
    signup_closure0.name = "signup_closure0";
  $desc = $collectedClasses.signup_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  signup_closure0.prototype = $desc;
  function fetchCurrentUser_closure() {
  }
  fetchCurrentUser_closure.builtin$cls = "fetchCurrentUser_closure";
  if (!"name" in fetchCurrentUser_closure)
    fetchCurrentUser_closure.name = "fetchCurrentUser_closure";
  $desc = $collectedClasses.fetchCurrentUser_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  fetchCurrentUser_closure.prototype = $desc;
  function fetchCurrentUser_closure0() {
  }
  fetchCurrentUser_closure0.builtin$cls = "fetchCurrentUser_closure0";
  if (!"name" in fetchCurrentUser_closure0)
    fetchCurrentUser_closure0.name = "fetchCurrentUser_closure0";
  $desc = $collectedClasses.fetchCurrentUser_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  fetchCurrentUser_closure0.prototype = $desc;
