...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    }, "call$1", "get$noSuchMethod", 2, 0, null, 61],
...
["baasbox", "package:baasbox/baasbox.dart", , O, {
  "^": "",
  BaasBoxCollection: {
    "^": "Object;name"
  },
  BaasBoxConfig: {
    "^": "Object;mPassword,mKeystoreRes,mUseHttps,mHttpCharset,mHttpPort,mHttpConnectionTimeout,mHttpSocketTimeout,mApiDomain,mApiBasepath,mAppCode,mAuthenticationType,mSessionTokenExpires,mSenderIds",
    BaasBoxConfig$0: function() {
      this.mApiBasepath = "/";
      this.mApiDomain = "127.0.0.1";
      this.mAppCode = "1234567890";
      this.mAuthenticationType = "SESSION_TOKEN";
      this.mHttpCharset = "UTF-8";
      this.mHttpConnectionTimeout = 6000;
      this.mHttpSocketTimeout = 10000;
      this.mHttpPort = 9000;
      this.mKeystoreRes = 0;
      this.mSessionTokenExpires = false;
      this.mUseHttps = false;
      this.mPassword = null;
    },
    static: {"^": "BaasBoxConfig_apiBasepath,BaasBoxConfig_apiDomain,BaasBoxConfig_appCode,BaasBoxConfig_authenticationType,BaasBoxConfig_httpCharset,BaasBoxConfig_httpConnectionTimeout,BaasBoxConfig_httpSocketTimeout,BaasBoxConfig_httpPort,BaasBoxConfig_keystoreRes,BaasBoxConfig_keyStorePass,BaasBoxConfig_sessionTokenExpires,BaasBoxConfig_useHttps,BaasBoxConfig_password"}
  },
  BaasBoxContext: {
    "^": "Object;_config,baasboxRequest,user",
    rest$4: function(method, endpoint, authenticate, body) {
      var completer, any, t1;
      completer = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]);
      any = this.baasboxRequest.any$4(0, method, endpoint, authenticate, body);
      any.toString;
      t1 = H.setRuntimeTypeInfo(new W._EventStream(any, C.EventStreamProvider_loadend._eventType, false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new O.BaasBoxContext_rest_closure(this, completer, any)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      return completer.future;
    },
    rest$3: function(method, endpoint, authenticate) {
      return this.rest$4(method, endpoint, authenticate, null);
    },
    static: {"^": "BaasBoxContext_SDK_VERSION,BaasBoxContext__baasboxcontext", BaasBoxContext_BaasBoxContext: function() {
        var t1, t2, api, t3;
        if ($.BaasBoxContext__baasboxcontext == null) {
          t1 = new O.BaasBoxContext(null, null, null);
          $.BaasBoxContext__baasboxcontext = t1;
          t2 = new O.BaasBoxConfig(null, null, null, null, null, null, null, null, null, null, null, null, null);
          t2.BaasBoxConfig$0();
          t1._config = t2;
          api = P.StringBuffer$("");
          api.write$1(t2.mUseHttps ? "https://" : "http://");
          api.write$1(t2.mApiDomain);
          api.write$1(":");
          api.write$1(t2.mHttpPort);
          t3 = t2.mApiBasepath;
          if (t3.length === 0)
            api.write$1("/");
          else if (C.JSString_methods.startsWith$1(t3, "/"))
            api.write$1(t2.mApiBasepath);
          else {
            api.write$1("/");
            api.write$1(t2.mApiBasepath);
          }
          t1.baasboxRequest = new O.BaasBoxRequest(t2, api._contents, O.BaasBoxContext_BaasBoxContext());
        }
        return $.BaasBoxContext__baasboxcontext;
      }}
  },
  BaasBoxContext_rest_closure: {
    "^": "Closure:55;this_0,completer_1,any_2",
    call$1: [function($event) {
      var t1, parsedBody, t2;
      t1 = this.any_2;
      parsedBody = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
      t2 = t1.status;
      if (t2 === 200 || t2 === 201)
        parsedBody = C.JsonCodec_null_null.decode$1(W._convertNativeToDart_XHR_Response(t1.response));
      else
        P.print(C.JSString_methods.$add("Error ", W._convertNativeToDart_XHR_Response(t1.response)));
      t1 = this.completer_1.future;
      if (t1._state !== 0)
        H.throwExpression(P.StateError$("Future already completed"));
      t1._asyncComplete$1(parsedBody);
      return;
    }, "call$1", null, 2, 0, null, 2, "call"],
    $isFunction: true
  },
  BaasBoxDocument: {
    "^": "Object;data>,collection,id>,author,creation_date,rid,version",
    create$2: function(collection, dataInDocument) {
      var ftr = O.BaasBoxContext_BaasBoxContext().rest$4("POST", "/document/" + collection, true, dataInDocument);
      ftr.then$1(new O.BaasBoxDocument_create_closure(this));
      return ftr;
    }
  },
  BaasBoxDocument_create_closure: {
    "^": "Closure:55;this_0",
    call$1: [function(documentCreated) {
      var t1, t2;
      t1 = this.this_0;
      t2 = J.$index$asx(documentCreated, "data");
      t1.data = t2;
      t1.id = J.$index$asx(t2, "id");
    }, "call$1", null, 2, 0, null, 69, "call"],
    $isFunction: true
  },
  BaasBoxRequest: {
    "^": "Object;_config,_apiRoot,_bbCtxt",
    any$4: function(_, method, endpointApi, requireSessionId, body) {
      var endpoint, httpR, json;
      endpoint = C.JSString_methods.startsWith$1(endpointApi, "/") ? C.JSString_methods.substring$1(endpointApi, 1) : endpointApi;
      endpoint = this._apiRoot + endpoint;
      switch (method) {
        case "GET":
          httpR = new XMLHttpRequest();
          C.HttpRequest_methods.open$2(httpR, "GET", endpoint);
          httpR.setRequestHeader("X-BAASBOX-APPCODE", this._config.mAppCode);
          if (requireSessionId)
            httpR.setRequestHeader("X-BB-SESSION", this._bbCtxt.user.$index(0, "token"));
          httpR.send();
          return httpR;
        case "POST":
          httpR = new XMLHttpRequest();
          C.HttpRequest_methods.open$2(httpR, "POST", endpoint);
          httpR.setRequestHeader("X-BAASBOX-APPCODE", this._config.mAppCode);
          if (requireSessionId)
            httpR.setRequestHeader("X-BB-SESSION", this._bbCtxt.user.$index(0, "token"));
          if (body != null) {
            json = C.JsonCodec_null_null.encode$1(body);
        ...
        case "POSTFORM":
          ...
          httpR.send(this.encodeMap$1(body));
          return httpR;
        case "PUT":
          httpR = new XMLHttpRequest();
          C.HttpRequest_methods.open$2(httpR, "PUT", endpoint);
          if (requireSessionId)
            httpR.setRequestHeader("X-BB-SESSION", this._bbCtxt.user.$index(0, "token"));
          if (body != null) {
            json = C.JsonCodec_null_null.encode$1(body);
        ...
        case "DELETE":
          httpR = new XMLHttpRequest();
          C.HttpRequest_methods.open$2(httpR, "DELETE", endpoint);
          if (requireSessionId)
            httpR.setRequestHeader("X-BB-SESSION", this._bbCtxt.user.$index(0, "token"));
          httpR.send();
          return httpR;
    ...
    encodeMap$1: function(data) {
      var t1 = data.get$keys();
      return H.MappedIterable_MappedIterable(t1, new O.BaasBoxRequest_encodeMap_closure(data), H.getRuntimeTypeArgument(t1, "IterableBase", 0), null).join$1(0, "&");
    },
    static: {"^": "BaasBoxRequest_BASIC_AUTH_HEADER_NAME,BaasBoxRequest_BB_SESSION_HEADER_NAME,BaasBoxRequest_APPCODE_HEADER_NAME,BaasBoxRequest_CONTENT_HEADER,BaasBoxRequest_JSON_CONTENT,BaasBoxRequest_FORM_ENCODED_CONTENT,BaasBoxRequest_USER_AGENT_HEADER_NAME,BaasBoxRequest_USER_AGENT_HEADER,BaasBoxRequest_CONTENT_LENGTH"}
  },
  BaasBoxRequest_encodeMap_closure: {
    "^": "Closure:55;data_0",
    call$1: [function(k) {
      return P.Uri__uriEncode(C.List_KIf, k, C.Utf8Codec_false, false) + "=" + P.Uri__uriEncode(C.List_KIf, this.data_0.$index(0, k), C.Utf8Codec_false, false);
    }, "call$1", null, 2, 0, null, 70, "call"],
    $isFunction: true
  },
  BaasBoxUser: {
    "^": "Object;_username,_password,_authToken,_signupDate,_status,followersList,roles",
    login$0: function() {
      var bbCtxt = O.BaasBoxContext_BaasBoxContext();
      return bbCtxt.rest$4("POSTFORM", "/login", false, P.LinkedHashMap_LinkedHashMap$_literal(["username", this._username, "password", this._password, "appcode", bbCtxt._config.mAppCode], null, null)).then$1(new O.BaasBoxUser_login_closure(bbCtxt));
    },
    changePassword$1: function(newPassword) {
      return O.BaasBoxContext_BaasBoxContext().rest$4("PUT", "/me/password", true, P.LinkedHashMap_LinkedHashMap$_literal(["old", this._password, "new", newPassword], null, null));
    },
    followers$0: function() {
      return O.BaasBoxContext_BaasBoxContext().rest$3("GET", "/followers/" + this._username, true).then$1(new O.BaasBoxUser_followers_closure(this));
    }
  },
  BaasBoxUser_login_closure: {
    "^": "Closure:55;bbCtxt_0",
    call$1: [function(response) {
      var t1 = J.getInterceptor$asx(response);
      this.bbCtxt_0.user = P.LinkedHashMap_LinkedHashMap$_literal(["username", J.$index$asx(J.$index$asx(t1.$index(response, "data"), "user"), "name"), "token", J.$index$asx(t1.$index(response, "data"), "X-BB-SESSION"), "visibleByAnonymousUsers", J.$index$asx(t1.$index(response, "data"), "visibleByAnonymousUsers"), "visibleByTheUser", J.$index$asx(t1.$index(response, "data"), "visibleByTheUser"), "visibleByFriends", J.$index$asx(t1.$index(response, "data"), "visibleByFriends"), "visibleByRegisteredUsers", J.$index$asx(t1.$index(response, "data"), "visibleByRegisteredUsers")], null, null);
      return;
    }, "call$1", null, 2, 0, null, 71, "call"],
    $isFunction: true
  },
  BaasBoxUser_followers_closure: {
    "^": "Closure:55;this_0",
    call$1: [function(onResponse) {
      P.print(onResponse);
      this.this_0.followersList = J.$index$asx(onResponse, "data");
...
["", "baasbox_test.dart", , Y, {
  ...
  main: [function() {
    ...
    N.group("OO BaasBox Dart SDK User ", new Y.main_closure());
    N.group("OO BaasBox Dart SDK Document ", new Y.main_closure0());
    N.group("OO BaasBox Dart SDK Collection ", new Y.main_closure1());
  ...
  main_closure: {
    ...
    call$0: function() {
      ...
      $.get$_currentContext().set$testSetup(new Y.main__closure(t1));
      N.test("Create User ", new Y.main__closure0());
      N.test("Login User ", new Y.main__closure1(t1));
      N.test("Fetch User ", new Y.main__closure2());
      N.test("Current User ", new Y.main__closure3());
      N.test("Change Password ", new Y.main__closure4());
      N.test("Follow User ", new Y.main__closure5());
      N.test("Followers User ", new Y.main__closure6());
      N.test("Unfollow", new Y.main__closure7());
      N.test("Logout User ", new Y.main__closure8());
    },
    $isFunction: true
  },
  main__closure: {
    "^": "Closure:62;box_0",
    call$0: [function() {
      this.box_0.bbCtxt_0 = O.BaasBoxContext_BaasBoxContext();
    }, "call$0", null, 0, 0, null, "call"],
    $isFunction: true
  },
  main__closure0: {
    "^": "Closure:62;",
    call$0: function() {
      Y.expect(O.BaasBoxContext_BaasBoxContext().rest$4("POST", "/user", false, P.LinkedHashMap_LinkedHashMap$_literal(["username", "Giovanni", "password", null], null, null)), C._Completes_PGb, null, null, false);
    },
    $isFunction: true
  },
  main__closure1: {
    ...
    call$0: function() {
      var aBBUser, result;
      aBBUser = new O.BaasBoxUser("test", null, null, null, null, null, null);
      aBBUser._password = "test";
      result = aBBUser.login$0();
      result.then$1(new Y.main___closure6(this.box_0));
      Y.expect(result, C._Completes_PGb, null, null, false);
    },
    $isFunction: true
  },
  main___closure6: {
    ...
    call$1: [function(value) {
      return P.print("Current User " + J.toString$0(this.box_0.bbCtxt_0.user));
  ...
  main__closure2: {
    ...
    call$0: function() {
      ...
      aBBUser._password = "test";
      result = aBBUser.login$0();
      result.then$1(new Y.main___closure5(aBBUser));
      Y.expect(result, C._Completes_PGb, null, null, false);
    },
    $isFunction: true
  },
  main___closure5: {
    "^": "Closure:55;aBBUser_3",
    call$1: [function(value) {
      return O.BaasBoxContext_BaasBoxContext().rest$3("GET", "/user/test", true).then$1(new Y.main____closure2());
    }, "call$1", null, 2, 0, null, 16, "call"],
    $isFunction: true
  },
  main____closure2: {
    ...
    call$1: [function(onValue) {
      return P.print("Fetch User " + H.S(onValue));
  ...
  main__closure3: {
    ...
    call$0: function() {
      ...
      aBBUser._password = "test";
      result = aBBUser.login$0();
      result.then$1(new Y.main___closure4(aBBUser));
      Y.expect(result, C._Completes_PGb, null, null, false);
    },
    $isFunction: true
  },
  main___closure4: {
    "^": "Closure:55;aBBUser_4",
    call$1: [function(value) {
      return O.BaasBoxContext_BaasBoxContext().rest$3("GET", "/me", true).then$1(new Y.main____closure1());
    }, "call$1", null, 2, 0, null, 16, "call"],
    $isFunction: true
  },
  main____closure1: {
    "^": "Closure:55;",
    call$1: [function(onValue) {
      return P.print("Current User " + H.S(onValue));
    }, "call$1", null, 2, 0, null, 73, "call"],
    $isFunction: true
  },
  main__closure4: {
    ...
    call$0: function() {
      ...
      aBBUser._password = "test";
      result = aBBUser.login$0();
      result.then$1(new Y.main___closure3(aBBUser));
      aBBUser.changePassword$1("test");
      Y.expect(result, C._Completes_PGb, null, null, false);
    },
    $isFunction: true
  },
  main___closure3: {
    "^": "Closure:55;aBBUser_5",
    call$1: [function(value) {
      return this.aBBUser_5.changePassword$1("test").then$1(new Y.main____closure0());
    }, "call$1", null, 2, 0, null, 16, "call"],
    $isFunction: true
  },
  main____closure0: {
    "^": "Closure:55;",
    call$1: [function(onValue) {
      P.print("Change Password " + H.S(onValue));
    }, "call$1", null, 2, 0, null, 73, "call"],
    $isFunction: true
  },
  main__closure5: {
    "^": "Closure:62;",
    call$0: function() {
      var aBBUser = new O.BaasBoxUser("test", null, null, null, null, null, null);
      aBBUser._password = "test";
      Y.expect(aBBUser.login$0().then$1(new Y.main___closure2(aBBUser)), C._Completes_PGb, null, null, false);
    },
    $isFunction: true
  },
  main___closure2: {
    "^": "Closure:55;aBBUser_6",
    call$1: [function(value) {
      return O.BaasBoxContext_BaasBoxContext().rest$3("POST", "/follow/Giovanni", true);
    }, "call$1", null, 2, 0, null, 16, "call"],
    $isFunction: true
  },
  main__closure6: {
    ...
    call$0: function() {
      var aBBUser = new O.BaasBoxUser("test", null, null, null, null, null, null);
      aBBUser._password = "test";
      Y.expect(aBBUser.login$0().then$1(new Y.main___closure1(aBBUser)), C._Completes_PGb, null, null, false);
    },
    $isFunction: true
  },
  main___closure1: {
    "^": "Closure:55;aBBUser_7",
    call$1: [function(value) {
      var t1 = this.aBBUser_7;
      return t1.followers$0().then$1(new Y.main____closure(t1));
    }, "call$1", null, 2, 0, null, 16, "call"],
    $isFunction: true
  },
  main____closure: {
    "^": "Closure:55;aBBUser_8",
    call$1: [function(onValue) {
      return P.print(C.JSString_methods.$add("Followers ", J.toString$0(this.aBBUser_8.followersList)));
    }, "call$1", null, 2, 0, null, 73, "call"],
    $isFunction: true
  },
  main__closure7: {
    ...
    call$0: function() {
      var aBBUser = new O.BaasBoxUser("test", null, null, null, null, null, null);
      aBBUser._password = "test";
      Y.expect(aBBUser.login$0().then$1(new Y.main___closure0(aBBUser)), C._Completes_PGb, null, null, false);
    },
    $isFunction: true
  },
  main___closure0: {
    "^": "Closure:55;aBBUser_9",
    call$1: [function(value) {
      return O.BaasBoxContext_BaasBoxContext().rest$3("DELETE", "/follow/Giovanni", true);
    }, "call$1", null, 2, 0, null, 16, "call"],
    $isFunction: true
  },
  main__closure8: {
    ...
    call$0: function() {
      var aBBUser = new O.BaasBoxUser("test", null, null, null, null, null, null);
      aBBUser._password = "test";
      Y.expect(aBBUser.login$0().then$1(new Y.main___closure(aBBUser)), C._Completes_PGb, null, null, false);
    },
    $isFunction: true
  },
  main___closure: {
    "^": "Closure:55;aBBUser_10",
    call$1: [function(value) {
      return O.BaasBoxContext_BaasBoxContext().rest$3("POST", "/logout", true);
    }, "call$1", null, 2, 0, null, 16, "call"],
    $isFunction: true
  },
  main_closure0: {
    ...
    call$0: function() {
      ...
      if ($._currentTestCaseIndex !== -1)
        H.throwExpression(P.StateError$("Not allowed when tests are running."));
      $.get$_currentContext().set$testSetup(new Y.main__closure9(t1));
      N.test("Create Document ", new Y.main__closure10());
      N.test("Delete Document ", new Y.main__closure11());
      N.test("Count Documents ", new Y.main__closure12());
      N.test("Update Document field ", new Y.main__closure13());
    },
    $isFunction: true
  },
  main__closure9: {
    "^": "Closure:62;box_1",
    call$0: [function() {
      this.box_1.bbCtxt_1 = O.BaasBoxContext_BaasBoxContext();
    }, "call$0", null, 0, 0, null, "call"],
    $isFunction: true
  },
  main__closure10: {
    ...
    call$0: function() {
      var aBBUser = new O.BaasBoxUser("test", null, null, null, null, null, null);
      aBBUser._password = "test";
      Y.expect(aBBUser.login$0().then$1(new Y.main___closure10(new O.BaasBoxDocument(null, null, null, null, null, null, null))), C._Completes_PGb, null, null, false);
    },
    $isFunction: true
  },
  main___closure10: {
    "^": "Closure:55;bbDocument_11",
    call$1: [function(value) {
      var t1 = this.bbDocument_11;
      t1.create$2("testcollection", P.LinkedHashMap_LinkedHashMap$_literal(["text", "ciao da giovanni"], null, null)).then$1(new Y.main____closure6(t1));
    }, "call$1", null, 2, 0, null, 16, "call"],
    $isFunction: true
  },
  main____closure6: {
    "^": "Closure:55;bbDocument_12",
    call$1: [function(createResponse) {
      return P.print(C.JSString_methods.$add("Documento creato ", this.bbDocument_12.id));
  ...
  main__closure11: {
    ...
    call$0: function() {
      var aBBUser = new O.BaasBoxUser("test", null, null, null, null, null, null);
      aBBUser._password = "test";
      Y.expect(aBBUser.login$0().then$1(new Y.main___closure9(new O.BaasBoxDocument(null, null, null, null, null, null, null))), C._Completes_PGb, null, null, false);
    },
    $isFunction: true
  },
  main___closure9: {
    "^": "Closure:55;bbDocument_13",
    call$1: [function(value) {
      var t1 = this.bbDocument_13;
      t1.create$2("testcollection", P.LinkedHashMap_LinkedHashMap$_literal(["text", "da cancellare"], null, null)).then$1(new Y.main____closure5(t1));
    }, "call$1", null, 2, 0, null, 16, "call"],
    $isFunction: true
  },
  main____closure5: {
    "^": "Closure:55;bbDocument_14",
    call$1: [function(createResponse) {
      return O.BaasBoxContext_BaasBoxContext().rest$3("DELETE", C.JSString_methods.$add("/document/testcollection/", this.bbDocument_14.id), true).then$1(new Y.main_____closure0());
    }, "call$1", null, 2, 0, null, 74, "call"],
    $isFunction: true
  },
  main_____closure0: {
    "^": "Closure:55;",
    call$1: [function(onValue) {
      return P.print("Delete Document " + H.S(onValue));
    }, "call$1", null, 2, 0, null, 73, "call"],
    $isFunction: true
  },
  main__closure12: {
    ...
    call$0: function() {
      var aBBUser = new O.BaasBoxUser("test", null, null, null, null, null, null);
      aBBUser._password = "test";
      Y.expect(aBBUser.login$0().then$1(new Y.main___closure8(new O.BaasBoxDocument(null, null, null, null, null, null, null))), C._Completes_PGb, null, null, false);
    },
    $isFunction: true
  },
  main___closure8: {
    "^": "Closure:55;bbDocument_15",
    call$1: [function(value) {
      O.BaasBoxContext_BaasBoxContext().rest$3("GET", "/document/testcollection/count", true).then$1(new Y.main____closure4());
    }, "call$1", null, 2, 0, null, 16, "call"],
    $isFunction: true
  },
  main____closure4: {
    "^": "Closure:55;",
    call$1: [function(onValue) {
      return P.print("Count " + H.S(onValue));
    }, "call$1", null, 2, 0, null, 73, "call"],
    $isFunction: true
  },
  main__closure13: {
    ...
    call$0: function() {
      var aBBUser = new O.BaasBoxUser("test", null, null, null, null, null, null);
      aBBUser._password = "test";
      Y.expect(aBBUser.login$0().then$1(new Y.main___closure7(new O.BaasBoxDocument(null, null, null, null, null, null, null))), C._Completes_PGb, null, null, false);
    },
    $isFunction: true
  },
  main___closure7: {
    "^": "Closure:55;bbDocument_16",
    call$1: [function(value) {
      var t1 = this.bbDocument_16;
      t1.create$2("testcollection", P.LinkedHashMap_LinkedHashMap$_literal(["text", "ciao da giovanni"], null, null)).then$1(new Y.main____closure3(t1));
    }, "call$1", null, 2, 0, null, 16, "call"],
    $isFunction: true
  },
  main____closure3: {
    "^": "Closure:55;bbDocument_17",
    call$1: [function(createResponse) {
      var t1, t2;
      t1 = this.bbDocument_17.id;
      t2 = P.LinkedHashMap_LinkedHashMap$_literal(["data", "edited field"], null, null);
      O.BaasBoxContext_BaasBoxContext().rest$4("PUT", "/document/testcollection/" + H.S(t1) + "/.text", true, t2).then$1(new Y.main_____closure());
    }, "call$1", null, 2, 0, null, 74, "call"],
    $isFunction: true
  },
  main_____closure: {
    "^": "Closure:55;",
    call$1: [function(onValue) {
      return P.print("Edit field " + H.S(onValue));
    }, "call$1", null, 2, 0, null, 73, "call"],
    $isFunction: true
  },
  main_closure1: {
    ...
    call$0: function() {
      ...
      if ($._currentTestCaseIndex !== -1)
        H.throwExpression(P.StateError$("Not allowed when tests are running."));
      $.get$_currentContext().set$testSetup(new Y.main__closure14(t1));
      N.test("Create Collection ", new Y.main__closure15());
      N.test("Delete Collection ", new Y.main__closure16());
      N.test("Load Documents ", new Y.main__closure17());
    },
    $isFunction: true
  },
  main__closure14: {
    "^": "Closure:62;box_2",
    call$0: [function() {
      this.box_2.bbCtxt_2 = O.BaasBoxContext_BaasBoxContext();
    }, "call$0", null, 0, 0, null, "call"],
    $isFunction: true
  },
  main__closure15: {
    "^": "Closure:62;",
    call$0: function() {
      var aBBUser = new O.BaasBoxUser("admin", null, null, null, null, null, null);
      aBBUser._password = "admin";
      Y.expect(aBBUser.login$0().then$1(new Y.main___closure13(new O.BaasBoxCollection("collectionnew"))), C._Completes_PGb, null, null, false);
    },
    $isFunction: true
  },
  main___closure13: {
    "^": "Closure:55;bbCollection_18",
    call$1: [function(value) {
      O.BaasBoxContext_BaasBoxContext().rest$3("POST", "/admin/collection/" + this.bbCollection_18.name, true).then$1(new Y.main____closure9());
    }, "call$1", null, 2, 0, null, 16, "call"],
    $isFunction: true
  },
  main____closure9: {
    "^": "Closure:55;",
    call$1: [function(createResponse) {
      return P.print("Collection created " + H.S(createResponse));
    }, "call$1", null, 2, 0, null, 74, "call"],
    $isFunction: true
  },
  main__closure16: {
    ...
    call$0: function() {
      var aBBUser = new O.BaasBoxUser("admin", null, null, null, null, null, null);
      aBBUser._password = "admin";
      Y.expect(aBBUser.login$0().then$1(new Y.main___closure12(new O.BaasBoxCollection("collectionnew"))), C._Completes_PGb, null, null, false);
    },
    $isFunction: true
  },
  main___closure12: {
    "^": "Closure:55;bbCollection_19",
    call$1: [function(value) {
      O.BaasBoxContext_BaasBoxContext().rest$3("DELETE", "/admin/collection/" + this.bbCollection_19.name, true).then$1(new Y.main____closure8());
    }, "call$1", null, 2, 0, null, 16, "call"],
    $isFunction: true
  },
  main____closure8: {
    "^": "Closure:55;",
    call$1: [function(createResponse) {
      return P.print("Collection deleted " + H.S(createResponse));
    }, "call$1", null, 2, 0, null, 74, "call"],
    $isFunction: true
  },
  main__closure17: {
    ...
    call$0: function() {
      var aBBUser = new O.BaasBoxUser("test", null, null, null, null, null, null);
      aBBUser._password = "test";
      Y.expect(aBBUser.login$0().then$1(new Y.main___closure11(new O.BaasBoxCollection("testcollection"))), C._Completes_PGb, null, null, false);
    },
    $isFunction: true
  },
  main___closure11: {
    "^": "Closure:55;bbCollection_20",
    call$1: [function(value) {
      O.BaasBoxContext_BaasBoxContext().rest$3("GET", "/document/" + this.bbCollection_20.name, true).then$1(new Y.main____closure7());
    }, "call$1", null, 2, 0, null, 16, "call"],
    $isFunction: true
  },
  main____closure7: {
    "^": "Closure:55;",
    call$1: [function(onValue) {
      return P.print("Load Documents " + H.S(onValue));
    }, "call$1", null, 2, 0, null, 73, "call"],
    $isFunction: true
  }
},
...
["dart.async", "dart:async", , P, {
  ...
  _ForwardingStreamSubscription: {
    ...
    }, "call$2", "get$_handleError", 4, 0, 82, 19, 20],
  ...
  _rootFork_closure: {
    "^": "Closure:66;copiedMap_0",
    call$2: [function(key, value) {
      this.copiedMap_0.$indexSet(0, key, value);
    }, "call$2", null, 4, 0, null, 83, 16, "call"],
    $isFunction: true
  },
...
["dart.convert", "dart:convert", , P, {
  ...
  }, "call$1", "_defaultToEncodable$closure", 2, 0, 41, 42],
  ...
  _Utf8Decoder_convert_addSingleBytes: {
    "^": "Closure:86;box_0,this_1,codeUnits_2",
...
["dart.core", "dart:core", , P, {
  ...
  Uri: {
    ...
    static: {"^": "Uri__SPACE,Uri__DOUBLE_QUOTE,Uri__NUMBER_SIGN,Uri__PERCENT,Uri__ASTERISK,Uri__PLUS,Uri__SLASH,Uri__ZERO,Uri__NINE,Uri__COLON,Uri__LESS,Uri__GREATER,Uri__QUESTION,Uri__AT_SIGN,Uri__UPPER_CASE_A,Uri__UPPER_CASE_F,Uri__UPPER_CASE_Z,Uri__LEFT_BRACKET,Uri__BACKSLASH,Uri__RIGHT_BRACKET,Uri__LOWER_CASE_A,Uri__LOWER_CASE_F,Uri__LOWER_CASE_Z,Uri__BAR,Uri__unreservedTable,Uri__unreserved2396Table,Uri__encodeFullTable,Uri__schemeTable,Uri__schemeLowerTable,Uri__subDelimitersTable,Uri__regNameTable,Uri__pathCharTable,Uri__queryCharTable", Uri_parse: function(uri) {
      ...
      }, "call$1", "Uri_decodeComponent$closure", 2, 0, 46, 47], Uri_parseIPv4Address: function(host) {
        var t1, bytes;
...
["dart.dom.html", "dart:html", , W, {
  ...
  Event: {
    "^": "Interceptor;",
    $isEvent: true,
    "%": "AudioProcessingEvent|AutocompleteErrorEvent|BeforeLoadEvent|BeforeUnloadEvent|CSSFontFaceLoadEvent|CloseEvent|CustomEvent|DeviceMotionEvent|DeviceOrientationEvent|HashChangeEvent|IDBVersionChangeEvent|InstallEvent|InstallPhaseEvent|MIDIConnectionEvent|MediaKeyNeededEvent|MediaStreamEvent|MediaStreamTrackEvent|MutationEvent|OfflineAudioCompletionEvent|OverflowEvent|PageTransitionEvent|PopStateEvent|RTCDTMFToneChangeEvent|RTCDataChannelEvent|RTCIceCandidateEvent|SecurityPolicyViolationEvent|SpeechInputEvent|SpeechRecognitionEvent|SpeechSynthesisEvent|StorageEvent|TrackEvent|TransitionEvent|WebGLContextEvent|WebKitAnimationEvent|WebKitTransitionEvent;Event|InputEvent"
  },
  EventTarget: {
    "^": "Interceptor;",
  ...
  _Html5NodeValidator: {
    ...
    static: {"^": "_Html5NodeValidator__allowedElements,_Html5NodeValidator__standardAttributes,_Html5NodeValidator__uriAttributes,_Html5NodeValidator__attributeValidators", _Html5NodeValidator$: function(uriPolicy) {
        ...
        return true;
      }, "call$4", "_Html5NodeValidator__standardAttributeValidator$closure", 8, 0, 48, 49, 50, 16, 51], _Html5NodeValidator__uriAttributeValidator: [function(element, attributeName, value, context) {
        var t1, t2, t3, t4, t5;
        ...
        if (!t1)
          ...
          t1 = true;
        return t1;
      }, "call$4", "_Html5NodeValidator__uriAttributeValidator$closure", 8, 0, 48, 49, 50, 16, 51]}
  },
  ImmutableListMixin: {
    "^": "Object;",
    get$iterator: function(receiver) {
...
["dart.js", "dart:js", , P, {
  ...
  }, "call$4", "_callDartFunction$closure", 8, 0, null, 52, 53, 22, 54],
  ...
  _DeepMatcher: {
    ...
    _recursiveMatch$4: [function(expected, actual, $location, depth) {
      ...
      if (!!J.getInterceptor(expected).$isMatcher) {
        if (J.matches$2$x(expected, actual, P.LinkedHashMap_LinkedHashMap$_empty(null, null)))
          return;
        t1 = new P.StringBuffer("");
        t1._contents = "";
        t1._contents = "";
        expected.get$_matcher();
        t1._contents += "completes successfully";
      ...
      return ["", $location];
    }, "call$4", "get$_recursiveMatch", 8, 0, 99],
...
["matcher.expect", "package:matcher/src/expect.dart", , Y, {
  ...
  _defaultErrorFormatter: [function(actual, matcher, reason, matchState, verbose) {
    ...
    return t1._contents;
  }, "call$5", "_defaultErrorFormatter$closure", 10, 0, 58],
  TestFailure: {
    "^": "Error;message>",
    toString$0: function(_) {
      return this.message;
...
["matcher.future_matchers", "package:matcher/src/future_matchers.dart", , Z, {
  ...
  _Completes: {
    ...
    describe$1: function(description) {
      description._out.write$1("completes successfully");
      return description;
    }
  },
  ...
  _Completes_matches__closure0: {
    "^": "Closure:62;this_3,value_4",
    call$0: [function() {
    }, "call$0", null, 0, 0, null, "call"],
    $isFunction: true
  },
  _Completes_matches_closure1: {
    "^": "Closure:66;this_5,done_6",
    ...
    }, "call$2", null, 4, 0, null, 19, 102, "call"],
    $isFunction: true
  },
...
["matcher.pretty_print", "package:matcher/src/pretty_print.dart", , S, {
  ...
  }, "call$1", "_escapeString$closure", 2, 0, 46, 59],
  _escapeChar: [function(ch) {
    ...
    if (t1.$eq(ch, "'"))
      ...
      return ch;
  }, "call$1", "_escapeChar$closure", 2, 0, 46, 60],
  prettyPrint__prettyPrint: {
    "^": "Closure:103;maxLineLength_1,maxItems_2",
    call$4: function(object, indent, seen, $top) {
      ...
      if (!!t2.$isIterable) {
        ...
        strings = J.map$1$ax(object.get$keys(), new S.prettyPrint__prettyPrint_closure0(object, t1)).toList$0(0);
        if (strings.length > this.maxItems_2) {
          t1 = strings.length;
          if (!!strings.fixed$length)
            H.throwExpression(P.UnsupportedError$("removeRange"));
  ...
  prettyPrint__prettyPrint_pp: {
    "^": "Closure:105;box_0,_prettyPrint_3,indent_4",
...
["unittest", "package:unittest/unittest.dart", , N, {
  ...
  _nextTestCase: [function() {
    ...
    N._runTest();
  }, "call$0", "_nextTestCase$closure", 0, 0, 13],
  ...
  filterTests: function(testFilter) {
    var filterFunction = new N.filterTests_closure(new H.JSSyntaxRegExp(testFilter, H.JSSyntaxRegExp_makeNative(testFilter, false, true, false), null, null));
  ...
  runTests: [function() {
    ...
    $._config.onStart$0();
    N._runTest();
  }, "call$0", "runTests$closure", 0, 0, 13],
  ...
  _GroupContext_testSetup_closure: {
    "^": "Closure:62;setup_0,preSetup_1",
    call$0: [function() {
      var f, t1;
      f = this.preSetup_1.call$0();
      t1 = this.setup_0;
      if (!!J.getInterceptor(f).$isFuture)
        return f.then$1(new N._GroupContext_testSetup__closure(t1));
      else
        return t1.call$0();
    }, "call$0", null, 0, 0, null, "call"],
    $isFunction: true
  ...
  _ExpectFailureHandler: {
    "^": "DefaultFailureHandler;_unittest$_config",
    fail$1: function(reason) {
      this._unittest$_config.onExpectFailure$1(reason);
    }
  },
  SimpleConfiguration: {
  ...
  _SpreadArgsHelper: {
    ...
    _max0$0: [function() {
      return this._max6$0();
    }, "call$0", "get$_max0", 0, 0, 62],
    _max1$1: [function(a0) {
      return this._max6$1(a0);
    }, function() {
      return this._max1$1(C.C__ArgPlaceHolder);
    }, "_max1$0", "call$1", "call$0", "get$_max1", 0, 2, 109, 110, 111],
    ...
    }, "_max2$1", "call$2", "call$0", "call$1", "get$_max2", 0, 4, 112, 110, 110, 111, 113],
    ...
    }, "_max3$2", "call$3", "call$0", "call$1", "call$2", "get$_max3", 0, 6, 114, 110, 110, 110, 111, 113, 115],
    ...
    }, "_max4$3", "call$4", "call$0", "call$1", "call$2", "call$3", "get$_max4", 0, 8, 116, 110, 110, 110, 110, 111, 113, 115, 117],
    ...
    }, "_max5$3", "call$5", "call$0", "call$1", "call$2", "call$4", "call$3", "get$_max5", 0, 10, 118, 110, 110, 110, 110, 110, 111, 113, 115, 117, 119],
    ...
    }, "_max6$5", "call$6", "call$0", "call$1", "call$2", "call$3", "call$4", "call$5", "get$_max6", 0, 12, 120, 110, 110, 110, 110, 110, 110, 111, 113, 115, 117, 119, 121],
  ...
  TestCase: {
    ...
    }, "call$0", "get$_markCallbackComplete", 0, 0, 13],
    toString$0: function(_) {
      var t1, t2;
      t1 = this._result;
      t2 = this.description;
  ...
  TestCase__errorHandler_closure: {
    ...
    }, "call$2", null, 4, 0, null, 1, 123, "call"],
    $isFunction: true
  },
  ...
  filterTests_closure0: {
    "^": "Closure:55;testFilter_1",
    call$1: function(t) {
  ...
  _runTest_closure: {
    "^": "Closure:66;testCase_1",
    call$2: [function(error, stack) {
      N._registerException(this.testCase_1, error, stack);
    }, "call$2", null, 4, 0, null, 19, 123, "call"],
    $isFunction: true
  },
  _runTest_closure0: {
    "^": "Closure:62;testCase_2,timeout_3",
    call$0: [function() {
...
["unittest.html_config", "package:unittest/html_config.dart", , D, {
  "^": "",
  _showResultsInPage: function(passed, failed, errors, results, isLayoutTest, uncaughtError) {
    var newBody, t1, t2, t3;
    if (isLayoutTest && passed === results._source.length && uncaughtError == null)
      J.setInnerHtml$1$x(document.body, "PASS");
    else {
      newBody = P.StringBuffer$("");
      newBody.write$1("<table class='unittest-table'><tbody>");
      t1 = results._source;
      newBody.write$1(passed === t1.length && uncaughtError == null ? "<tr><td colspan='3' class='unittest-pass'>PASS</td></tr>" : "<tr><td colspan='3' class='unittest-fail'>FAIL</td></tr>");
      for (t2 = results.get$iterator(results); t2.moveNext$0();) {
        t3 = D._toHtml(t2.__internal$_current);
        newBody._contents += t3;
      }
      t2 = uncaughtError == null;
      if (!t2)
        newBody.write$1("<tr>\n          <td>--</td>\n          <td class=\"unittest-error\">ERROR</td>\n          <td>Uncaught error: " + uncaughtError + "</td>\n        </tr>");
      if (passed === t1.length && t2)
        newBody.write$1("          <tr><td colspan='3' class='unittest-pass'>\n            All " + passed + " tests passed\n          </td></tr>");
      else {
        t1 = "          <tr><td colspan='3'>Total\n            <span class='unittest-pass'>" + passed + " passed</span>,\n            <span class='unittest-fail'>" + failed + " failed</span>\n            <span class='unittest-error'>\n            ";
        newBody.write$1(t1 + (errors + (t2 ? 0 : 1)) + " errors</span>\n          </td></tr>");
      }
      newBody.write$1("</tbody></table>");
      J.setInnerHtml$1$x(document.body, newBody._contents);
      t1 = H.setRuntimeTypeInfo(new W._EventStream(window, C.EventStreamProvider_hashchange._eventType, false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new D._showResultsInPage_closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    }
  },
  _toHtml: function(test_) {
    var t1, t2, val, html;
    if (!test_.get$isComplete())
      return "        <tr>\n          <td>" + H.S(J.get$id$x(test_)) + "</td>\n          <td class=\"unittest-error\">NO STATUS</td>\n          <td>Test did not complete</td>\n        </tr>";
    t1 = J.getInterceptor$x(test_);
    t2 = "      <tr>\n        <td>" + H.S(t1.get$id(test_)) + "</td>\n        <td class=\"unittest-" + H.S(t1.get$result(test_)) + "\">" + J.toUpperCase$0$s(t1.get$result(test_)) + "</td>\n        <td>Expectation: <a href=\"#testFilter=" + test_.get$description() + "\">" + test_.get$description() + "</a>. ";
    t1 = t1.get$message(test_);
    val = C.HtmlEscape_gsm._convert$3(t1, 0, J.get$length$asx(t1));
    html = t2 + H.S(val == null ? t1 : val) + "</td>\n      </tr>";
    if (test_.get$stackTrace() != null) {
      t1 = html + "<tr><td></td><td colspan=\"2\"><pre>";
      t2 = J.toString$0(test_.get$stackTrace());
      val = C.HtmlEscape_gsm._convert$3(t2, 0, J.get$length$asx(t2));
      html = C.JSString_methods.$add(t1, val == null ? t2 : val) + "</pre></td></tr>";
    }
    return html;
  },
  _showResultsInPage_closure: {
    "^": "Closure:55;",
    call$1: [function(_) {
      if (window.location.hash != null && J.contains$1$asx(window.location.hash, "testFilter"))
  ...
  HtmlConfiguration: {
    ...
    _installHandlers$0: function() {
      if (this._onErrorSubscription == null) {
        ...
        t1 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new D.HtmlConfiguration__installHandlers_closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)]);
        t1._tryResume$0();
      ...
      if (this._onMessageSubscription == null) {
        ...
        t1 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new D.HtmlConfiguration__installHandlers_closure0(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)]);
        t1._tryResume$0();
    ...
    onStart$0: function() {
      var hash, params, t1, parts, t2;
      hash = window.location.hash;
      if (hash != null && hash.length > 1) {
        params = J.substring$1$s(hash, 1).split("&");
        for (t1 = H.setRuntimeTypeInfo(new H.ListIterator(params, params.length, 0, null), [H.getTypeArgumentByIndex(params, 0)]); t1.moveNext$0();) {
          parts = J.split$1$s(t1.__internal$_current, "=");
          t2 = parts.length;
          if (t2 === 2) {
            if (0 >= t2)
              return H.ioore(parts, 0);
            t2 = J.$eq(parts[0], "testFilter");
          } else
            t2 = false;
          if (t2) {
            if (1 >= parts.length)
              return H.ioore(parts, 1);
            N.filterTests("^" + H.S(parts[1]));
          }
        }
      }
      K.Configuration.prototype.onStart$0.call(this);
    },
    onSummary$5: function(passed, failed, errors, results, uncaughtError) {
      D._showResultsInPage(passed, failed, errors, results, this._isLayoutTest, uncaughtError);
    },
    onDone$1: function(success) {
  ...
  HtmlConfiguration__installHandlers_closure: {
    "^": "Closure:55;",
    call$1: [function(e) {
      if (!J.$eq(J.$index$asx($.get$context1(), "testExpectsGlobalError"), true))
        N.handleExternalError(e, "(DOM callback has errors)", null);
    }, "call$1", null, 2, 0, null, 1, "call"],
    $isFunction: true
  },
  HtmlConfiguration__installHandlers_closure0: {
    "^": "Closure:55;this_0",
    call$1: [function(e) {
...
C._Completes_PGb = new Z._Completes(null, "");
...
$.BaasBoxContext__baasboxcontext = null;
$.printToZone = null;
$._nextCallback = null;
$._lastCallback = null;
...
Isolate.$lazy($, "context", "context1", "get$context1", function() {
...
Isolate.$lazy($, "_singletonNotLayout", "_singletonNotLayout", "get$_singletonNotLayout", function() {
  var t1 = new D.HtmlConfiguration(false, null, null, null, true, true, H.setRuntimeTypeInfo([], [[V.Pair, P.String, P.StackTrace]]), C.Duration_120000000);
  if ($._assertErrorFormatter == null)
    $._assertErrorFormatter = Y._defaultErrorFormatter$closure();
  Y.configureExpectFailureHandler(new N._ExpectFailureHandler(t1));
  return t1;
...
function dart_precompiled($collectedClasses) {
  ...
  function BaasBoxCollection(name) {
    this.name = name;
  }
  BaasBoxCollection.builtin$cls = "BaasBoxCollection";
  if (!"name" in BaasBoxCollection)
    BaasBoxCollection.name = "BaasBoxCollection";
  $desc = $collectedClasses.BaasBoxCollection;
  if ($desc instanceof Array)
    $desc = $desc[1];
  BaasBoxCollection.prototype = $desc;
  function BaasBoxConfig(mPassword, mKeystoreRes, mUseHttps, mHttpCharset, mHttpPort, mHttpConnectionTimeout, mHttpSocketTimeout, mApiDomain, mApiBasepath, mAppCode, mAuthenticationType, mSessionTokenExpires, mSenderIds) {
    this.mPassword = mPassword;
    this.mKeystoreRes = mKeystoreRes;
    this.mUseHttps = mUseHttps;
    this.mHttpCharset = mHttpCharset;
    this.mHttpPort = mHttpPort;
    this.mHttpConnectionTimeout = mHttpConnectionTimeout;
    this.mHttpSocketTimeout = mHttpSocketTimeout;
    this.mApiDomain = mApiDomain;
    this.mApiBasepath = mApiBasepath;
    this.mAppCode = mAppCode;
    this.mAuthenticationType = mAuthenticationType;
    this.mSessionTokenExpires = mSessionTokenExpires;
    this.mSenderIds = mSenderIds;
  }
  BaasBoxConfig.builtin$cls = "BaasBoxConfig";
  if (!"name" in BaasBoxConfig)
    BaasBoxConfig.name = "BaasBoxConfig";
  $desc = $collectedClasses.BaasBoxConfig;
  if ($desc instanceof Array)
    $desc = $desc[1];
  BaasBoxConfig.prototype = $desc;
  function BaasBoxContext(_config, baasboxRequest, user) {
    this._config = _config;
    this.baasboxRequest = baasboxRequest;
    this.user = user;
  }
  BaasBoxContext.builtin$cls = "BaasBoxContext";
  if (!"name" in BaasBoxContext)
    BaasBoxContext.name = "BaasBoxContext";
  $desc = $collectedClasses.BaasBoxContext;
  if ($desc instanceof Array)
    $desc = $desc[1];
  BaasBoxContext.prototype = $desc;
  function BaasBoxContext_rest_closure(this_0, completer_1, any_2) {
    this.this_0 = this_0;
    this.completer_1 = completer_1;
    this.any_2 = any_2;
  }
  BaasBoxContext_rest_closure.builtin$cls = "BaasBoxContext_rest_closure";
  if (!"name" in BaasBoxContext_rest_closure)
    BaasBoxContext_rest_closure.name = "BaasBoxContext_rest_closure";
  $desc = $collectedClasses.BaasBoxContext_rest_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  BaasBoxContext_rest_closure.prototype = $desc;
  function BaasBoxDocument(data, collection, id, author, creation_date, rid, version) {
    this.data = data;
  ...
  BaasBoxDocument.builtin$cls = "BaasBoxDocument";
  if (!"name" in BaasBoxDocument)
    BaasBoxDocument.name = "BaasBoxDocument";
  $desc = $collectedClasses.BaasBoxDocument;
  if ($desc instanceof Array)
    $desc = $desc[1];
  BaasBoxDocument.prototype = $desc;
  BaasBoxDocument.prototype.get$data = function(receiver) {
    return this.data;
  };
  BaasBoxDocument.prototype.get$id = function(receiver) {
    return this.id;
  };
  function BaasBoxDocument_create_closure(this_0) {
    this.this_0 = this_0;
  }
  BaasBoxDocument_create_closure.builtin$cls = "BaasBoxDocument_create_closure";
  if (!"name" in BaasBoxDocument_create_closure)
    BaasBoxDocument_create_closure.name = "BaasBoxDocument_create_closure";
  $desc = $collectedClasses.BaasBoxDocument_create_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  BaasBoxDocument_create_closure.prototype = $desc;
  function BaasBoxRequest(_config, _apiRoot, _bbCtxt) {
    this._config = _config;
    this._apiRoot = _apiRoot;
    this._bbCtxt = _bbCtxt;
  }
  BaasBoxRequest.builtin$cls = "BaasBoxRequest";
  if (!"name" in BaasBoxRequest)
    BaasBoxRequest.name = "BaasBoxRequest";
  $desc = $collectedClasses.BaasBoxRequest;
  if ($desc instanceof Array)
    $desc = $desc[1];
  BaasBoxRequest.prototype = $desc;
  function BaasBoxRequest_encodeMap_closure(data_0) {
    this.data_0 = data_0;
  }
  BaasBoxRequest_encodeMap_closure.builtin$cls = "BaasBoxRequest_encodeMap_closure";
  if (!"name" in BaasBoxRequest_encodeMap_closure)
    BaasBoxRequest_encodeMap_closure.name = "BaasBoxRequest_encodeMap_closure";
  $desc = $collectedClasses.BaasBoxRequest_encodeMap_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  BaasBoxRequest_encodeMap_closure.prototype = $desc;
  function BaasBoxUser(_username, _password, _authToken, _signupDate, _status, followersList, roles) {
  ...
  BaasBoxUser.builtin$cls = "BaasBoxUser";
  if (!"name" in BaasBoxUser)
    BaasBoxUser.name = "BaasBoxUser";
  $desc = $collectedClasses.BaasBoxUser;
  if ($desc instanceof Array)
    $desc = $desc[1];
  BaasBoxUser.prototype = $desc;
  function BaasBoxUser_login_closure(bbCtxt_0) {
    this.bbCtxt_0 = bbCtxt_0;
  }
  BaasBoxUser_login_closure.builtin$cls = "BaasBoxUser_login_closure";
  if (!"name" in BaasBoxUser_login_closure)
    BaasBoxUser_login_closure.name = "BaasBoxUser_login_closure";
  $desc = $collectedClasses.BaasBoxUser_login_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  BaasBoxUser_login_closure.prototype = $desc;
  function BaasBoxUser_followers_closure(this_0) {
    this.this_0 = this_0;
  }
  BaasBoxUser_followers_closure.builtin$cls = "BaasBoxUser_followers_closure";
  if (!"name" in BaasBoxUser_followers_closure)
    BaasBoxUser_followers_closure.name = "BaasBoxUser_followers_closure";
  $desc = $collectedClasses.BaasBoxUser_followers_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  BaasBoxUser_followers_closure.prototype = $desc;
  ...
  function main___closure6(box_0) {
    this.box_0 = box_0;
  }
  ...
  function main___closure5(aBBUser_3) {
    this.aBBUser_3 = aBBUser_3;
  }
  ...
  function main____closure2() {
  }
  main____closure2.builtin$cls = "main____closure2";
  if (!"name" in main____closure2)
    main____closure2.name = "main____closure2";
  $desc = $collectedClasses.main____closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  main____closure2.prototype = $desc;
  ...
  function main___closure4(aBBUser_4) {
    this.aBBUser_4 = aBBUser_4;
  }
  ...
  function main____closure1() {
  }
  main____closure1.builtin$cls = "main____closure1";
  if (!"name" in main____closure1)
    main____closure1.name = "main____closure1";
  $desc = $collectedClasses.main____closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  main____closure1.prototype = $desc;
  ...
  function main___closure3(aBBUser_5) {
    this.aBBUser_5 = aBBUser_5;
  }
  ...
  function main____closure0() {
  }
  main____closure0.builtin$cls = "main____closure0";
  if (!"name" in main____closure0)
    main____closure0.name = "main____closure0";
  $desc = $collectedClasses.main____closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  main____closure0.prototype = $desc;
  ...
  function main___closure2(aBBUser_6) {
    this.aBBUser_6 = aBBUser_6;
  }
  ...
  function main___closure1(aBBUser_7) {
    this.aBBUser_7 = aBBUser_7;
  }
  ...
  function main____closure(aBBUser_8) {
    this.aBBUser_8 = aBBUser_8;
  }
  ...
  function main___closure0(aBBUser_9) {
    this.aBBUser_9 = aBBUser_9;
  }
  ...
  function main___closure(aBBUser_10) {
    this.aBBUser_10 = aBBUser_10;
  }
  ...
  function main___closure10(bbDocument_11) {
    this.bbDocument_11 = bbDocument_11;
  }
  ...
  function main____closure6(bbDocument_12) {
    this.bbDocument_12 = bbDocument_12;
  }
  main____closure6.builtin$cls = "main____closure6";
  if (!"name" in main____closure6)
    main____closure6.name = "main____closure6";
  $desc = $collectedClasses.main____closure6;
  if ($desc instanceof Array)
    $desc = $desc[1];
  main____closure6.prototype = $desc;
  ...
  function main___closure9(bbDocument_13) {
    this.bbDocument_13 = bbDocument_13;
  }
  ...
  function main____closure5(bbDocument_14) {
    this.bbDocument_14 = bbDocument_14;
  }
  main____closure5.builtin$cls = "main____closure5";
  if (!"name" in main____closure5)
    main____closure5.name = "main____closure5";
  $desc = $collectedClasses.main____closure5;
  if ($desc instanceof Array)
    $desc = $desc[1];
  main____closure5.prototype = $desc;
  ...
  function main___closure8(bbDocument_15) {
    this.bbDocument_15 = bbDocument_15;
  }
  ...
  function main____closure4() {
  }
  main____closure4.builtin$cls = "main____closure4";
  if (!"name" in main____closure4)
    main____closure4.name = "main____closure4";
  $desc = $collectedClasses.main____closure4;
  if ($desc instanceof Array)
    $desc = $desc[1];
  main____closure4.prototype = $desc;
  ...
  function main___closure7(bbDocument_16) {
    this.bbDocument_16 = bbDocument_16;
  }
  ...
  function main____closure3(bbDocument_17) {
    this.bbDocument_17 = bbDocument_17;
  }
  main____closure3.builtin$cls = "main____closure3";
  if (!"name" in main____closure3)
    main____closure3.name = "main____closure3";
  $desc = $collectedClasses.main____closure3;
  if ($desc instanceof Array)
    $desc = $desc[1];
  main____closure3.prototype = $desc;
  ...
  function main__closure14(box_2) {
    this.box_2 = box_2;
  }
  ...
  function main___closure13(bbCollection_18) {
    this.bbCollection_18 = bbCollection_18;
  }
  ...
  function main____closure9() {
  }
  main____closure9.builtin$cls = "main____closure9";
  if (!"name" in main____closure9)
    main____closure9.name = "main____closure9";
  $desc = $collectedClasses.main____closure9;
  if ($desc instanceof Array)
    $desc = $desc[1];
  main____closure9.prototype = $desc;
  ...
  function main___closure12(bbCollection_19) {
    this.bbCollection_19 = bbCollection_19;
  }
  ...
  function main____closure8() {
  }
  main____closure8.builtin$cls = "main____closure8";
  if (!"name" in main____closure8)
    main____closure8.name = "main____closure8";
  $desc = $collectedClasses.main____closure8;
  if ($desc instanceof Array)
    $desc = $desc[1];
  main____closure8.prototype = $desc;
  function main__closure17() {
  }
  main__closure17.builtin$cls = "main__closure17";
  if (!"name" in main__closure17)
    main__closure17.name = "main__closure17";
  $desc = $collectedClasses.main__closure17;
  if ($desc instanceof Array)
    $desc = $desc[1];
  main__closure17.prototype = $desc;
  function main___closure11(bbCollection_20) {
    this.bbCollection_20 = bbCollection_20;
  }
  ...
  function main____closure7() {
  }
  main____closure7.builtin$cls = "main____closure7";
  if (!"name" in main____closure7)
    main____closure7.name = "main____closure7";
  $desc = $collectedClasses.main____closure7;
  if ($desc instanceof Array)
    $desc = $desc[1];
  main____closure7.prototype = $desc;
  ...
  function _Predicate(_core_matchers$_matcher, _description) {
    this._core_matchers$_matcher = _core_matchers$_matcher;
  ...
  function _Completes(_matcher, _future_matchers$_id) {
    this._matcher = _matcher;
    this._future_matchers$_id = _future_matchers$_id;
  }
  ...
  function _ExpectFailureHandler(_unittest$_config) {
    this._unittest$_config = _unittest$_config;
  }
  ...
  function _showResultsInPage_closure() {
  }
  _showResultsInPage_closure.builtin$cls = "_showResultsInPage_closure";
  if (!"name" in _showResultsInPage_closure)
    _showResultsInPage_closure.name = "_showResultsInPage_closure";
  $desc = $collectedClasses._showResultsInPage_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _showResultsInPage_closure.prototype = $desc;
  function HtmlConfiguration(_isLayoutTest, _onErrorSubscription, _onMessageSubscription, _receivePort, throwOnTestFailures, stopTestOnExpectFailure, _testLogBuffer, timeout) {
  ...
  HtmlConfiguration.builtin$cls = "HtmlConfiguration";
  if (!"name" in HtmlConfiguration)
    HtmlConfiguration.name = "HtmlConfiguration";
  $desc = $collectedClasses.HtmlConfiguration;
  if ($desc instanceof Array)
    $desc = $desc[1];
  HtmlConfiguration.prototype = $desc;
  function HtmlConfiguration__installHandlers_closure() {
  }
  HtmlConfiguration__installHandlers_closure.builtin$cls = "HtmlConfiguration__installHandlers_closure";
  if (!"name" in HtmlConfiguration__installHandlers_closure)
    HtmlConfiguration__installHandlers_closure.name = "HtmlConfiguration__installHandlers_closure";
  $desc = $collectedClasses.HtmlConfiguration__installHandlers_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  HtmlConfiguration__installHandlers_closure.prototype = $desc;
  function HtmlConfiguration__installHandlers_closure0(this_0) {
    this.this_0 = this_0;
  }
  HtmlConfiguration__installHandlers_closure0.builtin$cls = "HtmlConfiguration__installHandlers_closure0";
  if (!"name" in HtmlConfiguration__installHandlers_closure0)
    HtmlConfiguration__installHandlers_closure0.name = "HtmlConfiguration__installHandlers_closure0";
  $desc = $collectedClasses.HtmlConfiguration__installHandlers_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  HtmlConfiguration__installHandlers_closure0.prototype = $desc;
